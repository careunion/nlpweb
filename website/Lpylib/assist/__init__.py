...
class Topic_Judge:
    ...
    def main(self, question):
        ...
        if u"测量" in topic2 and u"血糖" in topic2 and u"数值" in topic2:
            return 20, self.xuetang(query, 1)
        elif u"测量" in topic2 and u"血糖" in topic2 and u"测了" in topic2:
            return 20, self.xuetang(query)

        if u"饮食" in topic2 and u"禁忌" in topic2 and u"查询" in topic2:
            return 11, topicword
        if u"饮食" in topic2 and u"禁忌" in topic2 and u"通知" in topic2:
            return 12, topicword
        #if u"测量" in topic2 and u"血糖" in topic2 and u"数值" in topic2 and u"查询" in topic2:
        #    return 13
        #if u"测量" in topic2 and u"血糖" in topic2 and u"数值" in topic2 and u"通知" in topic2:
        #    return 14
        return 0, ""
